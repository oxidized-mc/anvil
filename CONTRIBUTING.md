# Contributing to oxidized-anvil
...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/anvil.git
cd anvil
...
`oxidized-anvil` is a library crate in the
...
Use `anvil` as the scope for all changes to this crate.
