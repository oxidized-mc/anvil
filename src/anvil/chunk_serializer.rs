...
use oxidized_chunks::data_layer::DATA_LAYER_SIZE;
...
impl ChunkSerializer {
    ...
    fn serialize_block_states(
        &self,
        section: &oxidized_chunks::section::LevelChunkSection,
    ) -> NbtCompound {
...
mod tests {
    use super::*;
    use oxidized_chunks::data_layer::DataLayer;
    use oxidized_chunks::heightmap::Heightmap;
    use oxidized_chunks::level_chunk::{LevelChunk, OVERWORLD_HEIGHT, OVERWORLD_SECTION_COUNT};
